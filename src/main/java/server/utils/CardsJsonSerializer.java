...
import main.java.server.model.turn.building.*;
import main.java.server.model.turn.building.limiter.*;
import main.java.server.model.turn.movement.*;
import main.java.server.model.turn.movement.limiter.*;
import main.java.server.model.turn.strategy.*;
import main.java.server.model.turn.win.*;
import main.java.server.model.turn.win.limiter.*;
...
import static main.java.server.model.turn.strategy.TurnPhase.TurnPhaseType.BUILD;
import static main.java.server.model.turn.strategy.TurnPhase.TurnPhaseType.MOVE;
