package main.java.client.view.cli;


import main.java.client.utils.CardsDetailJsonDeserializer;
        ...
        if(message.getMessageSender() == MessageSender.CONTROLLER){
            ...
            switch(message.getMessageEvent()){
                ...
                case NUMB_PLAYERS:
                    ...
                    while (num<1||num>2){
                        print(CliConstants.NOT_A_VALID_MODE);
                        num = scanner.nextInt();
                    }
            ...
            switch(message.getMessageEvent()) {
                ...
                case DECK:
                    ...
                    if (username.equals(challenger)){
                        ...
                        cliFramework.updatePlayers(gameInfo.getPlayersInGame(),username);
                        cliFramework.printEnemyTurn(challenger, CliConstants.WAITING_FOR_CHALLENGER_CHOOSE_DECK);
                ...
                case CARD:
                    if(message.getPlayerUsername().equals(username)){
                        ...
                        cliFramework.updatePlayers(gameInfo.getPlayersInGame(),username);
                        cliFramework.printEnemyTurn(message.getPlayerUsername(), CliConstants.WAITING_FOR_ENEMY_TO_CHOOSE_CARD);
                        cliFramework.printScreen();
                ...
                case FIRST_PLAYER:
                    if (username.equals(challenger)){
                        ...
                        cliFramework.updatePlayers(gameInfo.getPlayersInGame(),username);
                        cliFramework.printEnemyTurn(challenger, CliConstants.WAITING_FOR_CHALLENGER_CHOOSE_FIRST_PLAYER);
                ...
                case COLOR:
                    if (message.getPlayerUsername().equals(username)) {
                        ...
                        cliFramework.updatePlayers(gameInfo.getPlayersInGame(),username);
                        cliFramework.printEnemyTurn(message.getPlayerUsername(), CliConstants.WAITING_FOR_ENEMY_TO_CHOOSE_COLOR);
                        cliFramework.printScreen();
                ...
                case PLACE_WORKER:
                    ...
                    if (message.getPlayerUsername().equals(username)){
                        ...
                        cliFramework.printEnemyTurn(message.getPlayerUsername(), CliConstants.WAITING_FOR_ENEMY_TO_PLACE_WORKERS);
                        cliFramework.printScreen();
            ...
            switch(message.getMessageEvent()) {
                case SHOW_POSSIBLE_ACTIONS:
                    if (message.getPlayerUsername().equals(username)) {
                        ...
                        cliFramework.updatePlayers(gameInfo.getPlayersInGame(), username);
                        cliFramework.printEnemyTurn(message.getPlayerUsername(), CliConstants.WAITING_FOR_ENEMY_TO_FINISH_TURN);
                        cliFramework.printScreen();
                ...
                case WIN:
                    if (message.getPlayerUsername().equals(username)){
                        ...
                        cliFramework.printPlayerWin(CliConstants.YOU);
                        cliFramework.printScreen();
                ...
                case LOSS:
                    if (message.getPlayerUsername().equals(username)){
                        cliFramework.printPlayerLost(CliConstants.YOU);
                        cliFramework.printScreen();
